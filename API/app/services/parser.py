...
Ported unchanged from the original Streamlit revoscope's revoscope/parser.py.
...
def load_transactions(csv_source: str | IO[bytes]) -> pd.DataFrame:
    """Load a Revolut transactions CSV export (path or file-like object)
