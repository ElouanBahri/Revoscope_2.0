...
Ported from the original Streamlit revoscope's revoscope/fx.py, with
st.cache_data swapped for the plain TTL cache in app.cache (see that
module's docstring for why).

Positions/trades can be recorded in whatever currency they were actually
executed in (e.g. EUR for a Xetra-listed UCITS ETF, USD for a US stock),
and non-US price history comes back from Yahoo Finance in that same native
currency. Since this app reports one consolidated portfolio in USD, both
need converting.
